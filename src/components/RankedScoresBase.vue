<template>
  <div :class="{ 'no-slide-transitions': !enableSlideTransitions }">
...
export default {
  ...
  methods: {
    ...
    async fetchCategoryData() {
      await fetch(this.apiBaseUrl + this.categoriesEndpoint)
        .then((response) => response.json())
        .then((data) => {
    ...
    async fetchRounds() {
      await fetch(
        this.apiBaseUrl + "/api/rounds?catId=" + this.currentCategory.CatId
      )
        .then((response) => response.json())
        .then((data) => {
          this.rounds = data;
...
.no-slide-transitions .slideup-leave-active,
.no-slide-transitions .slideup-enter-active,
.no-slide-transitions .slideright-leave-active,
.no-slide-transitions .slideright-enter-active,
.no-slide-transitions .slideup-enter-from,
.no-slide-transitions .slideup-leave-to,
.no-slide-transitions .slideup-leave-from .slideup-enter-to,
.no-slide-transitions .slideright-enter-from,
.no-slide-transitions .slideright-leave-to,
.no-slide-transitions .slideright-leave-from .slideright-enter-to {
